...
public class WebserviceUtils {
	...
	private static String getSoapAcction(String serviceName, String methodName) {
		String action = NAMESPACE + "I" + serviceName.substring(0, serviceName.indexOf(".")) + "/" + methodName;
	 ...
	 */
	private static SoapSerializationEnvelope getEnvelope(SoapObject request, int envolopeVesion, String serviceName,
			int timeout) throws IOException, XmlPullParserException {
	 ...
	 * @throws XmlPullParserException
	 */
	public static SoapPrimitive getSoapPrimitiveResponse(SoapObject request, int envolopeVesion, String serviceName)
	 ...
	 * @throws XmlPullParserException
	 */
	private static SoapSerializationEnvelope getEnvelope(String namespace, String method, String soapAction,
			String transUrl, LinkedHashMap<String, Object> properties, int envolopeVersion, int timeout)
			throws IOException, XmlPullParserException {
