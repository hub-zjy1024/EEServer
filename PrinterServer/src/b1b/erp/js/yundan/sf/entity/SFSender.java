...
public class SFSender {
     ...
     * 是否签回单，1：签，其他不签
     */
    public String need_return_tracking_no;
    /**
     * 签回单运单号
     */
    public String return_tracking;

    /**
     *  签回单路由标签返回：默认0，1：查询，其他：不查询
     */
    public int routelabelForReturn;

    /**
     *  路由标签查询服务：默认 0 不查询， 1 查询其他不查询
     */
    public int routelabelService;
