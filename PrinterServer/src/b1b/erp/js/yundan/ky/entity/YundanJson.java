package b1b.erp.js.yundan.ky.entity;


import java.io.Serializable;

import b1b.erp.js.yundan.ky.util.KyExpressUtils;
...
public class YundanJson implements Serializable {
    ...
    /**
     寄件公司（必）
     */
    public String col_001 = "";
    /**
     寄件联系人（必）
     */
    public String col_004 = "";
    /**
     寄件人手机（必）
     */
    public String col_005 = "";
    /**
     寄件电话（必）
     */
    public String col_003 = "";
    //寄件地址
    ...
    /**
     寄件地区号(必)
     */
    public String col_011 = "";
    //收件公司（必）
    public String col_006 = "";
    //收件联系人（必）
    public String col_010 = "";
    //收件地址（必）
    public String col_007 = "";
    //    收件手机（必）
    public String col_009 = "";
    //收件电话（必）
    public String col_008 = "";
    public String sjTelFJH = "";

    //件数(非)
    public String col_021 = "";
    //托寄物（必）
    public String col_019 = "";
    //    收件电话区号（非）
    public String sjTelQH = "";
    //寄件人区号（非）
    public String jjTelQH = "";
    //月结卡号
    public String col_037 = "";
    //付款方式（必）,寄付，到付，寄付月结，到付月结，转第三方付款，预存运费（填文字）
    public String col_013 = "";
    //代收金额（必，默认0）
    public String col_031 = "0";
    //是签回单(必)传1：签回单（面单上打印’签回单’）传0：不签回单（面单上面不用打印）
    public String col_028 = "";
    //备注（非）
    public String col_034 = "";
    //付款账号（非）
    public String payCardNo = "";
    //保价值
    public String col_027 = "";
    //保费（非）
    public String bfAmount = "";
    //唯品会入库号，col_006为唯品会时必填（必）
    public String vipshopCode = "";
