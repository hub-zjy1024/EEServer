...
import b1b.erp.js.yundan.ky.entity.YundanJson;
import b1b.erp.js.yundan.sf.jee.Log;
import b1b.erp.js.yundan.sf.sfutils.MySSLProtocolSocketFactory;
...
public class KyExpressUtils {
	...
	public static String sendPostRequest(YundanJson infos) throws IOException {
		...
		try {
			...
			sc.init(null,
					new TrustManager[] { new MySSLProtocolSocketFactory.TrustAnyTrustManager() },
					new SecureRandom());
