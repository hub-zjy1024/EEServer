...
import org.apache.commons.net.ftp.FTPClientConfig;import org.omg.PortableServer.THREAD_POLICY_ID;
...
public class DownUtils {
        ...
        if (this.isDebug) {
            listener = new ProtocolCommandListener() {
                ...
                public void protocolCommandSent(ProtocolCommandEvent event) {
                    System.out.println("send:"+event.getMessage());
                }
    ...
    public synchronized void login(int timeout) throws IOException {
        ...
        //同时设置Connect超时和Sotime超时
        mClient.setDefaultTimeout(timeout * 1000);
//        mClient.setControlKeepAliveTimeout(20*1000);
   ...
   public synchronized void logout() {
    ...
    public static String getTimeAtSS(){
