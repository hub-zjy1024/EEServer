...
import com.zjy.print.docx.office.PooledOfficeManagerSettings;
import com.zjy.print.docx.office.ProcessManager;
import com.zjy.print.docx.office.UnoUrl;

class MyOfficeManager implements OfficeManager {
	...
	private final Logger logger = Logger.getLogger(MyOfficeManager.class.getName());

	public MyOfficeManager(File officeHome, UnoUrl[] unoUrls, String[] runAsArgs,
	...
	@Override
	public void execute(com.zjy.print.docx.office.OfficeTask task)
			throws com.zjy.print.docx.office.OfficeException {
		if (!running) {
